...
<html>
	<head>
		...
		<script>
			...
			{
				<%
					Cookie ck = new Cookie("url",URLEncoder.encode("../furniture/new.jsp","euc-kr"));
		...
		<div style="width:750px; height:auto;margin:auto;">
			...
			<div style="height:30px;background-color:lightgray;">
				<table style="width:100%; padding-top:5px;" >
					<td id="td1"><a id="a1" href="#test">N E W</a></td><td id="td1"><a id="a1" href="../furniture/best.jsp#test" target="_self">BEST</a></td><td id="td1"><a id="a1" href="../furniture/desk.jsp#test">책 상</a></td><td id="td1"><a id="a1" href="../furniture/chir.jsp#test">의 자</a></td><td id="td1"><a id="a1" href="../furniture/sofa.jsp#test">소 파</a></td><td id="td1"><td id="td1"><a id="a1" href="../furniture/bed.jsp#test">침 대</a></td>
				</table>
			</div>
			<br>
			<font size="2.5px" weight="400">NEW 카테고리에 총 n개의 상품이 있습니다.</font>
			<br>
			<table style="height:180px;width:100%;align:left;">
				<tr>
					<td>
						<a id="a1"href="#">
							<img id=img1 src="../img/bed/bed05.jpg">
					...
					<td>
						<a id="a1"href="#">
							<img id=img1 src="../img/chir/chir09.jpg">
							<b style="border-bottom:2px solid lightgray;">&nbsp;&nbsp;&nbsp;&nbsp;</b><br><br>
							<font id="objcontent">i love macarong sweet time</font><br>
							<font id="objname">디자인과 함께하는 <i>M</i>&nbsp;&nbsp;HKA</font><br>
							<font id="objprice">30000원</font>
			...
			<table style="height:180px;width:100%;align:left;">
				<tr>
					...
					<td>
						<a id="a1"href="#">
							<img id=img1 src="../img/chir/chir02.jpg">
							<b style="border-bottom:2px solid lightgray;">&nbsp;&nbsp;&nbsp;&nbsp;</b><br><br>
							<font id="objcontent">i love macarong sweet time</font><br>
							<font id="objname">디자인과 함께하는 <i>M</i>&nbsp;&nbsp;HKA</font><br>
							<font id="objprice">30000원</font>
