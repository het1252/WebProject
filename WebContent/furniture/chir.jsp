...
<html>
	<head>
		...
		<script>
			...
			{
				<%
					Cookie ck = new Cookie("url",URLEncoder.encode("./furniture/chir.jsp","euc-kr"));
		...
		<div style="width:750px; height:auto;margin:auto;">
			...
			<div style="height:30px;background-color:lightgray;">
				<table style="width:100%; padding-top:5px;" >
					<td id="td1"><a id="a1" href="../furniture/new.jsp#test">N E W</a></td><td id="td1"><a id="a1" href="../furniture/best.jsp#test">BEST</a></td><td id="td1"><a id="a1" href="../furniture/desk.jsp#test">책 상</a></td><td id="td1"><a id="a1" href="#test">의 자</a></td><td id="td1"><a id="a1" href="../furniture/sofa.jsp#test">소 파</a></td><td id="td1"><td id="td1"><a id="a1" href="../funiture/bed.jsp#test">침 대</a></td>
				</table>
			</div>
			<br>
			...
			<table style="height:180px;width:100%;align:left;">
				<tr>
					<td>
						<a id="a1"href="#">
							<img id=img1 src="../img/chir/chir01.jpg">
			...
			<table style="height:180px;width:100%;align:left;">
				<tr>
					...
					<td>
						<a id="a1"href="#">
							<img id=img1 src="../img/chir/chir07.jpg">
							<b style="border-bottom:2px solid lightgray;">&nbsp;&nbsp;&nbsp;&nbsp;</b><br><br>
							<font id="objcontent">i love macarong sweet time</font><br>
							<font id="objname">디자인과 함께하는 <i>M</i>&nbsp;&nbsp;HKA</font><br>
							<font id="objprice">30000원</font>
